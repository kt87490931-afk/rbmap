...
async function main() {
  ...
  const footerContent = { ...(footerRow?.content || {}), desc: '믿을 수 있는 업소를 한눈에! 룸빵여지도에서 전국 유흥 정보를 확인하세요. 전국 380개 이상의 검증된 업소와 3,200건이 넘는 실제 이용 후기가 당신의 선택을 돕습니다. 6시간마다 자동으로 업데이트되는 최신 정보로 실패 없는 밤을 약속합니다.' };
