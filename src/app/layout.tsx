...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    const description = seo?.description || "믿을 수 있는 업소를 한눈에! 룸빵여지도에서 전국 유흥 정보를 확인하세요. 전국 380개 이상의 검증된 업소와 3,200건이 넘는 실제 이용 후기가 당신의 선택을 돕습니다.";
    ...
    return {
      ...
      description: "믿을 수 있는 업소를 한눈에! 룸빵여지도에서 전국 유흥 정보를 확인하세요. 전국 380개 이상의 검증된 업소와 3,200건이 넘는 실제 이용 후기가 당신의 선택을 돕습니다.",
...
export default function RootLayout({
  ...
  const webSiteSchema = {
    ...
    description: "믿을 수 있는 업소를 한눈에! 전국 룸싸롱·가라오케·셔츠룸·쩜오·퍼블릭·노래방 유흥 정보",
    inLanguage: "ko",
    potentialAction: {
      "@type": "SearchAction",
