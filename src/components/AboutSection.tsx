...
const DEFAULT_CARDS = [
  { icon: "🤖", title: "실시간 업데이트", desc: "Gemini AI가 실시간 Google Places 데이터를 분석해 6시간마다 리뷰와 업소 정보를 자동 생성합니다." },
      ...
      <div className="section-inner">
        ...
        <div className="section-head-row" style={{ flexDirection: "column", alignItems: "flex-start" }}>
          ...
          <p className="section-desc">
            룸빵여지도는 강남·수원·동탄·제주 등 전국 주요 지역의 가라오케·룸싸롱·하이퍼블릭·셔츠룸·퍼블릭 정보를 한눈에 비교할 수 있는 국내 최대 유흥 정보 허브입니다. Gemini AI가 Google Places 데이터를 기반으로 6시간마다 자동 업데이트합니다.
          </p>
        </div>
