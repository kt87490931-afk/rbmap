...
export async function generateReview(params: {
  ...
  const loveLineBlock =
    '[스토리 핵심 — Romantic & Visual, 반드시 70% 이상 반영]\n' +
    '1. 첫눈에 반함: 그녀가 룸에 들어오는 순간, 조명이 그녀를 비추고 세상이 멈춘 듯한 묘사. (연예인 누구를 닮았는지 구체적으로)\n' +
    '2. 핑크빛 기류: 대화 중 팔짱 끼거나, 귓속말, 눈 뚫어지게 쳐다보며 웃어주는 등 심쿵 포인트 3곳 이상.\n' +
    '3. 꼬시기 전략: 내가 던진 멘트와 그녀의 부끄러운 표정·능숙한 리액션을 대화문으로 생생히.\n' +
    '4. 아쉬운 작별: "오빠 벌써 가? 조금만 더 있다 가지..." 같은 아쉬움, 나중에 연락할 여운.\n' +
    '5. 미모 묘사: "피부 백옥, 강아지상 눈, 모델급 몸매"처럼 독자가 상상할 수 있게 구체적으로.\n\n'
